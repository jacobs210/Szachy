...
blacks.append(Piece(1, "Rook", Square(1, 8)))
blacks.append(Piece(1, "Rook", Square(8, 8)))
blacks.append(Piece(1, "Knight", Square(2, 8)))
blacks.append(Piece(1, "Knight", Square(7, 8)))
blacks.append(Piece(1, "Bishop", Square(3, 8)))
blacks.append(Piece(1, "Bishop", Square(6, 8)))
blacks.append(Piece(1, "Queen", Square(4, 8)))
blacks.append(Piece(1, "King", Square(5, 8)))
